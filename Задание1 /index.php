...
$works = [
    [
        ...
        "dateStart" => "март 2021",
        "dateEnd" => "август 2022",
        "description" => "Работала оператором в колл-центре на дому. Работала в компании Яндекс.Драйв. 
        Консультировала и помогала пользователям в проблемах связанных с автомобилями и пользованием самим приложением",
    ],
    [
